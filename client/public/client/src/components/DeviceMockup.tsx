          ...
          <div className="flex max-w-full flex-nowrap items-center justify-end gap-1.5 sm:gap-2">
            <div
              className={cn(
                ...
                isPlaying ? "w-[76px] sm:w-[88px] opacity-100" : "w-0 opacity-0"
              )}
            >
              <Button
                type="button"
                size="sm"
                variant="secondary"
                className="h-8 w-[76px] sm:w-[88px] rounded-md bg-white/90 px-2 sm:px-3 text-zinc-900 hover:bg-white whitespace-nowrap"
